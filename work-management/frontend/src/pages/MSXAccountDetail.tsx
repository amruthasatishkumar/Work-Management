            ...
            opportunities: [
              {
                ...
                opportunityIntent: opp[`msp_opportunitytype${FV}`] ?? null,
                activeSalesStage: opp[`msp_activesalesstage${FV}`] ?? opp.msp_activesalesstage ?? null,
                solutionArea: pickFieldRaw(opp, ['solutionarea']),
                recommendation: pickFieldRaw(opp, ['recommendation', 'forecastrecommendation', 'forecastcategory']),
