...
export const api = {
  ...
  msx: {
    ...
    refreshOpp: (data: { localOppId: number; comments: any[]; activities: any[]; msxActivityIds?: string[]; milestones?: any[]; solutionPlay?: string | null; opportunityIntent?: string | null; activeSalesStage?: string | null; solutionArea?: string | null; recommendation?: string | null }) =>
